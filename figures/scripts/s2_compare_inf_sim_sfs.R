###################
###Figure S2 --> Simulated v. Inferred SFS
###################
...
##########
sfs_10 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/sim_avg_sfs10.csv", sep = ',', h = T)
sfs_100 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/sim_avg_sfs100.csv", sep = ',', h = T)
sfs_1000 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/sim_avg_sfs1000.csv", sep = ',', h = T)
...
sfs_10 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/computed_avg_sfs10.csv", sep = ',', h = T)
sfs_100 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/computed_avg_sfs100.csv", sep = ',', h = T)
sfs_1000 = read.table("Lethals_Project-main/Lethals_Project-main/figures/data/computed_avg_sfs1000.csv", sep = ',', h = T)
...
df$Made_From = "Inferred"
sim_df$Made_From = "Simulated"

#combine fitdadi inferred sfs and simulated sfs
com_df = rbind(df, sim_df)


###All Together SFS Plot####
library(RColorBrewer)
#ss can be 10, 100, or 1000
gg = ggplot(com_df[which(com_df$ss == 1000),], aes(fill=factor(Source, levels = c("Inferred - 0.00", "Simulated - 0.00", "Inferred - 0.01", "Simulated - 0.01", "Inferred - 0.05", "Simulated - 0.05", "Inferred - 0.10", 'Simulated - 0.10')),
                    y=Number, x=Sites)) + 
  ...
  scale_fill_manual(values = c("#FF7F00", "#8B4500", "#87CEFF", "#4A708B", "#C1FFC1", "#698B69", 
    "#FFC125", "#8B6914"))

pdf(paste("figures/", "compare_inf_exp_sfs.pdf", sep=""),width = 15, height = 8)
print(gg)
dev.off()
